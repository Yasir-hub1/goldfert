  ...
  <div class="fixed top-4 right-4 z-50 space-y-2">
    <TransitionGroup name="toast" tag="div">
      <div
        ...
        class="min-w-[300px] max-w-md p-4 rounded-lg shadow-lg flex items-start justify-between gap-4"
      >
        <div class="flex items-start gap-3 flex-1">
          <div :class="getIconClasses(toast.type)" class="flex-shrink-0 mt-0.5">
